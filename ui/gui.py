...
class Ui_MainWindow(object):
    ...
    def setupMenuBar(self, MainWindow):
        ...
        self.actionExportAsXml.setObjectName(_fromUtf8("actionExportAsXml"))
        ...
        self.menuFile.addAction(self.actionExportAsXml)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionExportAsXml.setText(QtWidgets.QApplication.translate("MainWindow", "Export as XML", None))
        self.actionExportAsXml.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Export current session as XML", None))
